...
SWIFT_ENUM_FWD_DECL(uint8_t, CocoaMQTTCONNACKReasonCode)
...
SWIFT_ENUM_FWD_DECL(uint8_t, CocoaMQTTDISCONNECTReasonCode)
SWIFT_ENUM_FWD_DECL(uint8_t, CocoaMQTTAUTHReasonCode)
@class NSURLAuthenticationChallenge;
@class NSURLCredential;
@class MqttDecodePubComp;
SWIFT_ENUM_FWD_DECL(uint8_t, CocoaMQTTConnState)
/// CocoaMQTT5 Delegate
