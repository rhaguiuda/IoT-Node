...
export const RANGES: RangeConfig[] = [
  { id: "1m",  label: "1m",  seconds: 60,         downsampleSec: 5,   realtime: true },
  { id: "5m",  label: "5m",  seconds: 300,        downsampleSec: 5,   realtime: true },
  { id: "10m", label: "10m", seconds: 600,        downsampleSec: 5,   realtime: true },
  { id: "15m", label: "15m", seconds: 900,        downsampleSec: 5,   realtime: true },
  { id: "30m", label: "30m", seconds: 1800,       downsampleSec: 5,   realtime: true },
  { id: "1h",  label: "1h",  seconds: 3600,       downsampleSec: 5,   realtime: true },
  { id: "6h",  label: "6h",  seconds: 21600,      downsampleSec: 5,   realtime: true },
  { id: "12h", label: "12h", seconds: 43200,      downsampleSec: 10,  realtime: false },
  { id: "24h", label: "24h", seconds: 86400,      downsampleSec: 15,  realtime: false },
